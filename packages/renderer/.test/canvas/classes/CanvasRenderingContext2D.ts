import _DOMMatrix from './DOMMatrix'
import _CanvasPattern from './CanvasPattern'
//import _cssfontparser from './css'
import _TextMetrics from './TextMetrics'
import _createCanvasEvent from '../mock/createCanvasEvent'
import _Path2D from './Path2D'
...
export default class CanvasRenderingContext2D {
  ...
  __clearPath() {
    const event = (0, _createCanvasEvent.default)('beginPath', getTransformSlice(this), {}); // The clipping path should start after the initial beginPath instruction
